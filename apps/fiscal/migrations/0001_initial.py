# Generated by Django 5.1.7 on 2026-02-04 19:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expenses', to='invoicing.businessprofile', verbose_name='Empresa')),
            ],
            options={
                'verbose_name': 'Gasto',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('business_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fiscal_years', to='invoicing.businessprofile', verbose_name='Empresa')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, verbose_name='Notas')),
                ('fiscal_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quarters', to='fiscal.fiscalyear', verbose_name='Año fiscal')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('quarter', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='result', to='fiscal.quarter', verbose_name='Trimestre')),
            ],
            options={
